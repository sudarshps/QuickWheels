...
import {  Wallet, Calendar,IndianRupee,CarIcon } from "lucide-react";
...
const WalletUI:React.FC = () => {
      ...
      useEffect(()=>{
        axiosInstance.get('/getwalletdetails',{
            params:{
                userId
            }
        })
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent className="p-4">
              ...
              <div className="mb-6">
                ...
                <h2 className="text-3xl font-bold text-gray-900">₹{walletDetails?.wallet.balance}.00</h2>
              </div>
  ...
  {walletDetails?.wallet.history.length>0?<div className="space-y-4">
        ...
        <div className="flex justify-between items-start mb-2">
          <div className="flex items-center gap-2">
            <div className={`p-2 rounded-full ${transaction.type === 'Credit' ? 'bg-green-100' : 'bg-red-100'}`}>
              <IndianRupee className={`h-4 w-4 ${transaction.type === 'Credit' ? 'text-green-600' : 'text-red-600'}`} />
            </div>
            <div>
              ...
              {transaction.car && (
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className="text-sm text-gray-500">Car: Innova</p>
                </div>
              )}
            </div>
          </div>
  ...
  </div>:<h1 className='font-semibold'>No Transactions!</h1>}
</div>
